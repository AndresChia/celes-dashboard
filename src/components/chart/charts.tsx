import { LineChart, Line, CartesianGrid, XAxis, YAxis, Tooltip, XAxisProps, YAxisProps, TooltipProps, Legend } from 'recharts';
...
export const Charts = ({ data = [], lines, xAxis, yAxis, tooltip, width = 600, height = 300 }: Props) => {
